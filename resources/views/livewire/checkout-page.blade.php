		...
		<div class="grid grid-cols-12 gap-4">
			<div class="md:col-span-12 lg:col-span-8 col-span-12">
				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					<!-- Shipping Address -->
					<div class="mb-6">
						<h2 class="text-md font-semibold underline text-gray-700 dark:text-white mb-2">
							Shipping Address
						</h2>
						...
						<div class="mt-4">
							...
							<input wire:model="address" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('address') border-red-500 @enderror" id="address" type="text">
							</input>
							@error('address')
								<div class="text-red-500 text-sm">{{ $message }}</div>
							@enderror	
						...
						<div class="grid grid-cols-2 gap-4 mt-4">
							<div>
								...
								<input wire:model="country" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('country') border-red-500 @enderror" id="country" type="text">
								</input>
								@error('country')
									<div class="text-red-500 text-sm">{{ $message }}</div>
								@enderror	
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						<li>
							...
							<label class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700" for="hosting-small">
								<div class="block">
									<div class="w-full text-lg font-normal">
										Cash on Delivery
									</div>
								</div>
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					<div class="text-md font-bold underline text-gray-700 dark:text-white mb-2">
						ORDER SUMMARY
					</div>
					<div class="flex justify-between mb-2 font-normal">
						<span>
							Subtotal
						</span>
						<span>
