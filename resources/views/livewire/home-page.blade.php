<div>
    ...
    <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        class="block text-3xl font-bold text-slate-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                        Start your journey with <span class="text-blue-600">TallCart</span></h1>
                    <p class="mt-3 text-lg text-slate-800 dark:text-slate-400">Purchase wide varities of electronics
                        products like Smartphones, Laptops, Smartwatches, Television and many more.</p>

                    <!-- Buttons -->
                    <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                        <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-slate-600"
                            href="/register">
                            Get started
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                <svg class="h-4 w-4 text-slate-800 dark:text-slate-200" width="51" height="51"
                            ...
                            <p class="mt-3 text-sm text-slate-800 dark:text-slate-200">
                                <span class="font-bold">4.6</span> /5 - from 12k reviews
                            </p>

                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="h-auto w-16 text-slate-800 dark:text-white" width="80" height="27"
                        ...
                        <div class="py-5">
                            ...
                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="h-auto w-16 text-slate-800 dark:text-white" width="110" height="28"
                ...
                <div class="relative ms-4">
                    ...
                    <div
                        class="absolute inset-0 -z-[1] bg-gradient-to-tr from-slate-200 via-white/0 to-white/0 w-full h-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0">
                    </div>
        ...
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-slate-200"> Browse Popular<span class="text-blue-500"> Brands
                        </span> </h1>
                ...
                <p class="mb-12 text-base text-center text-slate-500">
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
                @foreach ($brands as $brand)    
                    <div class="bg-white rounded-lg shadow-md dark:bg-slate-800" wire:key="{{ $brand->id }}">
                        <a href="/products?selected_brands[0]={{ $brand->id }}" class="">
                            <img src="{{ url('storage', $brand->image) }}" alt="{{ $brand->name }}"
                                class="object-cover w-full h-64 rounded-t-lg">
                        </a>
                        <div class="p-5 text-center">
                            <a href="" class="text-1xl font-bold tracking-tight text-slate-900 dark:text-slate-300">
                                {{ $brand->name }}
                            </a>
                        </div>
                    </div>
    ...
    <div class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-slate-200"> Browse <span class="text-blue-500"> Categories
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                @foreach ($categories as $category)  
                    <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-slate-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-slate-600"
                        href="/categories/{{ $category->id }}" wire:key="{{ $category->id }}">
                        <div class="p-4 md:p-5">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-3">
                                        <h3
                                            class="group-hover:text-blue-600 font-semibold text-slate-800 dark:group-hover:text-slate-400 dark:text-slate-200">
                                            {{ $category->name }}
                                        </h3>
                                    </div>
                                </div>
    ...
    <section class="py-14 font-poppins dark:bg-slate-800">
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-slate-200"> Customer <span class="text-blue-500"> Reviews
                            </span> </h1>
                        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                            <div class="flex-1 h-2 bg-blue-200">
                            </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
                <div class="py-6 bg-white rounded-md shadow dark:bg-slate-900">
                    <div
                        class="flex flex-wrap items-center justify-between pb-4 mb-6 space-x-2 border-b dark:border-slate-700">
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-300">
                                    Adren Roy</h2>
                                <p class="text-xs text-slate-500 dark:text-slate-400">Web Designer</p>
                            </div>
                        </div>
                        <p class="px-6 text-base font-medium text-slate-600 dark:text-slate-400"> Joined 12, SEP , 2022
                        </p>
                    </div>
                    <p class="px-6 mb-6 text-base text-slate-500 dark:text-slate-400">
                    ...
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-slate-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            ...
                            <h2 class="text-sm text-slate-500 dark:text-slate-400">Rating:<span
                                    class="font-semibold text-slate-600 dark:text-slate-300">
                                    3.0</span>
                            </h2>
                        </div>
                        <div
                            class="flex items-center px-6 space-x-1 text-sm font-medium text-slate-500 dark:text-slate-400">
                            <div class="flex items-center">
                                <div class="flex mr-3 text-sm text-slate-700 dark:text-slate-400">
                                    <a href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor"
                                ...
                                <div class="flex text-sm text-slate-700 dark:text-slate-400">
                    ...
                    <div
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-300">
                                    William harry</h2>
                                <p class="text-xs text-slate-500 dark:text-slate-400">Marketing Officer</p>
                            </div>
                        </div>
                        <p class="px-6 text-base font-medium text-slate-600 dark:text-slate-400"> Joined 12, SEP , 2022
                        </p>
                    ...
                    <div
                        ...
                        <div class="flex items-center px-6 mb-2 md:mb-0 ">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-slate-900 dark:text-slate-300">
                                    James jack</h2>
                                <p class="text-xs text-slate-500 dark:text-slate-400">Java Programmer</p>
                            </div>
                        </div>
                        <p class="px-6 text-base font-medium text-slate-600 dark:text-slate-400"> Joined 12, SEP , 2022
                        </p>
